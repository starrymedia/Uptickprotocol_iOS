...
struct Tendermint_Types_Evidence {
  ...
  var lightClientAttackEvidence: Tendermint_Types_LightClientAttackEvidence {
    get {
      if case .lightClientAttackEvidence(let v)? = _storage._sum {return v}
      return Tendermint_Types_LightClientAttackEvidence()
    }
    set {_uniqueStorage()._sum = .lightClientAttackEvidence(newValue)}
  }
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2:
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._sum = .lightClientAttackEvidence(v)}
        default: break
        }
      }
    }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try decoder.decodeSingularInt64Field(value: &_storage._validatorPower)
...
extension Tendermint_Types_LightClientAttackEvidence: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularMessageField(value: &_storage._conflictingBlock)
        case 2: try decoder.decodeSingularInt64Field(value: &_storage._commonHeight)
        case 3: try decoder.decodeRepeatedMessageField(value: &_storage._byzantineValidators)
        case 4: try decoder.decodeSingularInt64Field(value: &_storage._totalVotingPower)
        case 5: try decoder.decodeSingularMessageField(value: &_storage._timestamp)
        default: break
        }
      }
