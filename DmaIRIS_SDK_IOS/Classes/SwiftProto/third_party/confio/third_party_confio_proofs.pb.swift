...
struct Ics23_CommitmentProof {
  ...
  var proof: OneOf_Proof? {
    get {return _storage._proof}
    set {_uniqueStorage()._proof = newValue}
  }

  var exist: Ics23_ExistenceProof {
    get {
      if case .exist(let v)? = _storage._proof {return v}
      return Ics23_ExistenceProof()
    }
    set {_uniqueStorage()._proof = .exist(newValue)}
  }

  var nonexist: Ics23_NonExistenceProof {
    get {
      if case .nonexist(let v)? = _storage._proof {return v}
      return Ics23_NonExistenceProof()
    }
    set {_uniqueStorage()._proof = .nonexist(newValue)}
  }

  var batch: Ics23_BatchProof {
    get {
      if case .batch(let v)? = _storage._proof {return v}
      return Ics23_BatchProof()
    }
    set {_uniqueStorage()._proof = .batch(newValue)}
  }

  var compressed: Ics23_CompressedBatchProof {
    get {
      if case .compressed(let v)? = _storage._proof {return v}
      return Ics23_CompressedBatchProof()
    }
    set {_uniqueStorage()._proof = .compressed(newValue)}
  }
...
struct Ics23_ProofSpec {
  ...
  var leafSpec: Ics23_LeafOp {
    get {return _storage._leafSpec ?? Ics23_LeafOp()}
    set {_uniqueStorage()._leafSpec = newValue}
  }
  /// Returns true if `leafSpec` has been explicitly set.
  var hasLeafSpec: Bool {return _storage._leafSpec != nil}
  /// Clears the value of `leafSpec`. Subsequent reads from it will return its default value.
  mutating func clearLeafSpec() {_uniqueStorage()._leafSpec = nil}

  var innerSpec: Ics23_InnerSpec {
    get {return _storage._innerSpec ?? Ics23_InnerSpec()}
    set {_uniqueStorage()._innerSpec = newValue}
  }
  /// Returns true if `innerSpec` has been explicitly set.
  var hasInnerSpec: Bool {return _storage._innerSpec != nil}
  /// Clears the value of `innerSpec`. Subsequent reads from it will return its default value.
  mutating func clearInnerSpec() {_uniqueStorage()._innerSpec = nil}
  ...
  var minDepth: Int32 {
    get {return _storage._minDepth}
    set {_uniqueStorage()._minDepth = newValue}
  }
...
extension Ics23_ExistenceProof: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _leaf: Ics23_LeafOp? = nil
    var _path: [Ics23_InnerOp] = []
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try decoder.decodeSingularMessageField(value: &_storage._leaf)
        case 4: try decoder.decodeRepeatedMessageField(value: &_storage._path)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._leaf {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      }
      if !_storage._path.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._path, fieldNumber: 4)
      }
    }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularBytesField(value: &_storage._key)
        case 2: try decoder.decodeSingularMessageField(value: &_storage._left)
        case 3: try decoder.decodeSingularMessageField(value: &_storage._right)
        default: break
        }
      }
    }
...
extension Ics23_CommitmentProof: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _proof: Ics23_CommitmentProof.OneOf_Proof?
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 1:
          ...
          if let current = _storage._proof {
            try decoder.handleConflictingOneOf()
            if case .exist(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._proof = .exist(v)}
        case 2:
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._proof = .nonexist(v)}
        case 3:
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._proof = .batch(v)}
        case 4:
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._proof = .compressed(v)}
        default: break
        }
      }
    }
...
extension Ics23_ProofSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _leafSpec: Ics23_LeafOp? = nil
    var _innerSpec: Ics23_InnerSpec? = nil
    var _maxDepth: Int32 = 0
    var _minDepth: Int32 = 0
    ...
    init(copying source: _StorageClass) {
      _leafSpec = source._leafSpec
      _innerSpec = source._innerSpec
      _maxDepth = source._maxDepth
      _minDepth = source._minDepth
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularMessageField(value: &_storage._leafSpec)
        case 2: try decoder.decodeSingularMessageField(value: &_storage._innerSpec)
        case 3: try decoder.decodeSingularInt32Field(value: &_storage._maxDepth)
        case 4: try decoder.decodeSingularInt32Field(value: &_storage._minDepth)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if let v = _storage._leafSpec {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
      }
      if let v = _storage._innerSpec {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      }
      if _storage._maxDepth != 0 {
        try visitor.visitSingularInt32Field(value: _storage._maxDepth, fieldNumber: 3)
      }
      if _storage._minDepth != 0 {
        try visitor.visitSingularInt32Field(value: _storage._minDepth, fieldNumber: 4)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Ics23_ProofSpec, rhs: Ics23_ProofSpec) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._leafSpec != rhs_storage._leafSpec {return false}
        if _storage._innerSpec != rhs_storage._innerSpec {return false}
        if _storage._maxDepth != rhs_storage._maxDepth {return false}
        if _storage._minDepth != rhs_storage._minDepth {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Ics23_BatchEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _proof: Ics23_BatchEntry.OneOf_Proof?
...
extension Ics23_CompressedBatchEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _proof: Ics23_CompressedBatchEntry.OneOf_Proof?
...
extension Ics23_CompressedExistenceProof: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularBytesField(value: &_storage._value)
        case 3: try decoder.decodeSingularMessageField(value: &_storage._leaf)
        case 4: try decoder.decodeRepeatedInt32Field(value: &_storage._path)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._path.isEmpty {
        try visitor.visitPackedInt32Field(value: _storage._path, fieldNumber: 4)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
