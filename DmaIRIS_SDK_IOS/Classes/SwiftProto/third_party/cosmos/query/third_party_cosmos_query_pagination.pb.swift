...
///          PageRequest page = 2;
///  }
struct Cosmos_Query_PageRequest {
...
///          PageResponse page = 2;
///  }
struct Cosmos_Query_PageResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "cosmos.query"

extension Cosmos_Query_PageRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cosmos_Query_PageRequest, rhs: Cosmos_Query_PageRequest) -> Bool {
...
extension Cosmos_Query_PageResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cosmos_Query_PageResponse, rhs: Cosmos_Query_PageResponse) -> Bool {
