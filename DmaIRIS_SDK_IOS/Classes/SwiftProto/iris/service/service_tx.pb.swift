...
extension Irismod_Service_MsgCallService: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 8: try decoder.decodeSingularBoolField(value: &self.repeated)
      case 9: try decoder.decodeSingularUInt64Field(value: &self.repeatedFrequency)
      case 10: try decoder.decodeSingularInt64Field(value: &self.repeatedTotal)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.repeated != false {
      try visitor.visitSingularBoolField(value: self.repeated, fieldNumber: 8)
    }
    if self.repeatedFrequency != 0 {
      try visitor.visitSingularUInt64Field(value: self.repeatedFrequency, fieldNumber: 9)
    }
    if self.repeatedTotal != 0 {
      try visitor.visitSingularInt64Field(value: self.repeatedTotal, fieldNumber: 10)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
