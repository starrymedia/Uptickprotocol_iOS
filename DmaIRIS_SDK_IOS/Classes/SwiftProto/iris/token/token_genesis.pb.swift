...
struct Irismod_Token_GenesisState {
  ...
  var burnCoins: [Cosmos_Base_V1beta1_Coin] {
    get {return _storage._burnCoins}
    set {_uniqueStorage()._burnCoins = newValue}
  }
...
extension Irismod_Token_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "params"),
    2: .same(proto: "tokens"),
    3: .standard(proto: "burn_coins"),
  ]

  fileprivate class _StorageClass {
    var _params: Irismod_Token_Params? = nil
    var _tokens: [Irismod_Token_Token] = []
    var _burnCoins: [Cosmos_Base_V1beta1_Coin] = []
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try decoder.decodeRepeatedMessageField(value: &_storage._burnCoins)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._burnCoins.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._burnCoins, fieldNumber: 3)
      }
    }
  ...
  static func ==(lhs: Irismod_Token_GenesisState, rhs: Irismod_Token_GenesisState) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._burnCoins != rhs_storage._burnCoins {return false}
        return true
      }
