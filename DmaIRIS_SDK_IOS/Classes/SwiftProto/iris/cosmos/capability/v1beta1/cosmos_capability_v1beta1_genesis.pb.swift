...
struct Cosmos_Capability_V1beta1_GenesisOwners {
  ...
  var indexOwners: Cosmos_Capability_V1beta1_CapabilityOwners {
    get {return _storage._indexOwners ?? Cosmos_Capability_V1beta1_CapabilityOwners()}
    set {_uniqueStorage()._indexOwners = newValue}
  }
  /// Returns true if `indexOwners` has been explicitly set.
  var hasIndexOwners: Bool {return _storage._indexOwners != nil}
  /// Clears the value of `indexOwners`. Subsequent reads from it will return its default value.
  mutating func clearIndexOwners() {_uniqueStorage()._indexOwners = nil}
...
extension Cosmos_Capability_V1beta1_GenesisOwners: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _index: UInt64 = 0
    var _indexOwners: Cosmos_Capability_V1beta1_CapabilityOwners? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _indexOwners = source._indexOwners
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularMessageField(value: &_storage._indexOwners)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._indexOwners {
  ...
  static func ==(lhs: Cosmos_Capability_V1beta1_GenesisOwners, rhs: Cosmos_Capability_V1beta1_GenesisOwners) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._indexOwners != rhs_storage._indexOwners {return false}
        return true
      }
