...
struct Irismod_Token_MsgTransferTokenOwner {
  ...
  var srcOwner: Data = SwiftProtobuf.Internal.emptyData

  var dstOwner: Data = SwiftProtobuf.Internal.emptyData
...
extension Irismod_Token_MsgIssueToken: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 8: try decoder.decodeSingularBytesField(value: &self.owner)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.owner.isEmpty {
      try visitor.visitSingularBytesField(value: self.owner, fieldNumber: 8)
    }
...
extension Irismod_Token_MsgTransferTokenOwner: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularBytesField(value: &self.srcOwner)
      case 2: try decoder.decodeSingularBytesField(value: &self.dstOwner)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.srcOwner.isEmpty {
      try visitor.visitSingularBytesField(value: self.srcOwner, fieldNumber: 1)
    }
    if !self.dstOwner.isEmpty {
      try visitor.visitSingularBytesField(value: self.dstOwner, fieldNumber: 2)
    }
    if !self.symbol.isEmpty {
...
extension Irismod_Token_MsgMintToken: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try decoder.decodeSingularBytesField(value: &self.owner)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.owner.isEmpty {
      try visitor.visitSingularBytesField(value: self.owner, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
